    ...
    <div class="min-h-screen py-12 bg-[#faf6ed] sm:px-6 lg:px-8">
        ...
        >
            <form @submit.prevent="submitCase" method="POST">
                ...
                <div x-show="theCase.gemaraText"
                    class="ltr gc-diagram grid grid-cols-6 gap-x-8 gap-y-24 justify-items-center border-4 border-indigo-500 rounded-md p-4 mt-4 max-w-screen-xl mx-auto"
                >
...
@endforeach
                ...
                <div x-show="theCase.gemaraText">
                    <div class="flex justify-center p-0 my-0">
                        <div class="w-2 bg-indigo-500 h-24 -mt-5"></div>
                    </div>
                    <div class="flex justify-center">
                        <div class="arrow-head"></div>
                    </div>
                    <div
                        class="gc-din-type w-1/4 mx-auto border-indigo-600 bg-indigo-500 text-white rounded-md h-16 -mt-4 text-xs flex flex-col justify-center items-center">
