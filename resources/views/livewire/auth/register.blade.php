...
<div>
    <div class="sm:mx-auto sm:w-full sm:max-w-md">
        ...
        <p class="mt-2 text-sm text-center text-stone-600 leading-5 max-w">
            Or
            <a href="{{ route('login') }}" class="font-medium text-teal-600 hover:text-teal-700 focus:outline-none focus:underline transition ease-in-out duration-150">
    ...
    <div class="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
        <div class="px-4 py-8 bg-white shadow-sm border border-stone-200 sm:rounded-2xl sm:px-10">
            <form wire:submit="register">
                <div>
                    <label for="name" class="block text-sm font-medium text-stone-700 leading-5">
                        Name
                    </label>
                    <div class="mt-1">
                        <input wire:model.blur="name" id="name" type="text" required autofocus class="appearance-none block w-full px-3 py-2.5 bg-stone-50 border border-stone-300 rounded-lg placeholder-stone-400 focus:outline-none focus:ring-2 focus:ring-teal-500 focus:border-teal-500 transition duration-150 ease-in-out sm:text-sm sm:leading-5 @error('name') border-red-300 text-red-900 placeholder-red-300 focus:border-red-300 focus:ring-red-500 @enderror" />
                    </div>
                    @error('name')
                ...
                <div class="mt-6">
                    ...
                    <div class="mt-1">
                        <input wire:model.blur="passwordConfirmation" id="password_confirmation" type="password" required class="block w-full px-3 py-2.5 bg-stone-50 placeholder-stone-400 border border-stone-300 appearance-none rounded-lg focus:outline-none focus:ring-2 focus:ring-teal-500 focus:border-teal-500 transition duration-150 ease-in-out sm:text-sm sm:leading-5" />
                    </div>
                </div>
