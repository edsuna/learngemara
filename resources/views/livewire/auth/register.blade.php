...
<div>
    <div class="sm:mx-auto sm:w-full sm:max-w-md">
        ...
        <p class="mt-2 text-sm text-center text-gray-600 leading-5 max-w">
            Or
            <a href="{{ route('login') }}" class="font-medium text-indigo-700 hover:text-indigo-900 focus:outline-none focus:underline transition ease-in-out duration-150">
        ...
        <div class="px-4 py-8 bg-white shadow-sm rounded-md border-2 border-[#c7b299] sm:px-10">
            <form wire:submit="register">
                ...
                <div class="mt-6">
                    ...
                    <div class="mt-1 rounded-md shadow-sm">
                        <input wire:model.blur="passwordConfirmation" id="password_confirmation" type="password" required class="block w-full px-3 py-2 bg-[#fefce8] placeholder-gray-400 border border-stone-300 appearance-none rounded-md focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 transition duration-150 ease-in-out sm:text-sm sm:leading-5" />
                    </div>
                </div>
